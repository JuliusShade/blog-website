...
- Staging: `https://staging-julius.shade.dev/api/auth/github`
- Production: `https://julius.shade.dev/api/auth/github`
...
- WIF binding scoped to the `JuliusShade/blog` repository
