...
| Property                           | ID        | Purpose             |
| ---------------------------------- | --------- | ------------------- |
| julius.shade.dev                   | 449163216 | Production          |
| julius.shade.dev - Stage and Local | 321994447 | Staging + local dev |

Both properties live under the **Julius Shade** GA account (19124393).

## Measurement IDs

| Environment | Stream  | Measurement ID | URL                              |
| ----------- | ------- | -------------- | -------------------------------- |
| Production  | Prod    | `G-PH525YF11W` | https://julius.shade.dev         |
| Staging     | Staging | `G-KNKR69G927` | https://staging-julius.shade.dev |
| Local       | Local   | `G-57YWQXB9F0` | http://local.julius.shade.dev    |
