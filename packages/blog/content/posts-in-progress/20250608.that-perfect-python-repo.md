...
While working on my [last post about creating my own CLI tool - Towles Tool](https://blog.towles.dev/2025/06/07/creating-my-own-cli-tool-towles-tool/) I came across [that perfect repo](https://github.com/JuliusShade/towles-tool) that has inspired me to take my project to the next level.
