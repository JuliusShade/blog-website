...
_Note: Google Wave was discontinued, but you can learn about its legacy through [Wikipedia](https://en.wikipedia.org/wiki/Google_Wave) or try [Apache Wave](https://incubator.apache.org/projects/wave.html), the open-source successor._
...
I could `git clone` my entire knowledge base anywhere—home machine, work machine—and I ended up with a toolbox I could always take with me.
...
_Now stop reading about it and start building your own human-AI collaboration protocol. Your future self will thank you._
