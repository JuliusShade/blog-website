...
As a developer, you're probably no stranger to the world of version control systems like Git. But even if you're well-versed in the basics of Git, using [conventional commits](https://www.conventionalcommits.org/) can be a game-changer when it comes to communicating with your peers and yourself.
...
- **Better release management:** When you use conventional commits, it's easier to generate a changelog that reflects the changes in your release.
  - Not a requirement for personal or many web projects, but many OSS projects need to generate a changelog.
...
At first, it may seem like a lot of work to write a commit message. But you'll find that writing good commit messages becomes easier as you get used to doing it. I also recommend committing more often.
...
This is great for a couple of reasons. The standard makes it easier to generate release notes and changelog from the commit messages.
...
But be sure to review the rules for the repository you're contributing to.
