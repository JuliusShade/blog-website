...
That's the deal with building in public. You ship your mistakes alongside your wins. The lesson here isn't "session resumption is bad" - it's that **what you optimize for becomes your goal, whether you meant it to or not**. I've since updated [towles-tool](https://github.com/JuliusShade/towles-tool/) and removed all the session marker stuff.
