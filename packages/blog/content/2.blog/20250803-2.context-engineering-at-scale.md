...
- Build context sharing as core criteria for everything
  - If your work doesn't produce context, what's it really doing?
  - Your work makes a part; it should produce something an MCP call could search for
  - "Did I send an email to Josh yesterday?" An LLM with an MCP tool for your email should be able to answer that.
...
3. **Experiment with MCP**: Explore how tools can share context through standardized protocols
