...
- So writing document specifications may be even more important than writing code.
  - Give a look at these requirements for a project, which really embraced this idea. I used Claude to translate from Japanese to English: [Requirements for a Project](https://github.com/JuliusShade/cc-jsonl/blob/main/docs/requirements.md)
- Use pictures.
