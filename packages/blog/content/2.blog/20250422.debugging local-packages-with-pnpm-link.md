...
`pnpm link` is a useful tool for local package development. It makes stepping into the code with breakpoints and debugging a breeze. See the [PNPM docs on link](https://pnpm.io/cli/link) for more details.
