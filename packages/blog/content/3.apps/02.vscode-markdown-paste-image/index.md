...
image:
  ...
  alt: 'Logo of julius-shade.markdown-paste-image'
...
- GitHub - <https://github.com/JuliusShade/vscode-markdown-paste-image>
- Marketplace - <https://marketplace.visualstudio.com/items?itemName=julius-shade.markdown-paste-image>
...
```
ext install julius-shade.markdown-paste-image
```
